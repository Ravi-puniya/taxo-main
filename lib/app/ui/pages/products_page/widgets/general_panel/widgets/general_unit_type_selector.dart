...
class GeneralUnitTypeSelector extends GetView<ProductFormController> {
  const GeneralUnitTypeSelector({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SmartSelect<UnitType?>.single(
      ...
      choiceItems: controller.unitTypesChoices.value,
      modalFilter: true,
