...
class MarcasService extends GetConnect {
  ...
  Future<Response> listarMarcas() async {
    print('Realizando solicitud para obtener marcas...');
    // Antes de realizar la solicitud, actualiza la URL base y los encabezados
    updateBaseUrlAndHeaders();
    return await get("/brands-records");
  }

  // Método para agregar una nueva Marcas
  Future<Response> agregarMarcas(String nombre) async {
    // Antes de realizar la solicitud, actualiza la URL base y los encabezados
    updateBaseUrlAndHeaders();
    Map<String, dynamic> body = {"name": nombre};
    return await post("/brands", body);
  }
}
